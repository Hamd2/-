<?php 
// BY TOKYO - @iiiiBii & @ZzZJJ //
ob_start();
$admin = "1735531135"; // Your ID //
define('API_KEY','1893320885:AAH2_r0PY8ETaYlXVXI2lSjSg5ohdOzmGCY'); // Your Token //
...
'reply_markup'=>json_encode(['inline_keyboard'=>[
  ...
  [['text'=>'- TOKYO .','url'=>'https://t.me/iiiiBii']],
  ],
  ])
  ]);
  }
...
'reply_markup'=>json_encode(['inline_keyboard'=>[
  ...
  $TOKYOc = file_get_contents($chat_id);
  if($text and $text != '/start' and $TOKYOc == 'putbin'){
      bot('sendMessage' ,[
          'chat_id'=>$chat_id,
...
$montheTOKYO = $monthcode[$montherand];
$yearcode = ['2022','2023','2024','2025','2026'];
$yearrand = array_rand($yearcode,1);
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode1 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode2 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode3 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode4 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode5 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode6 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode7 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode8 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
$code1 = array_rand($codes,1);
$code2 = array_rand($codes,1);
$code3 = array_rand($codes,1);
$code4 = array_rand($codes,1);
...
$yearTOKYO = $yearcode[$yearrand];
$TOKYO = "$bcode3$bcode10$bcode5";
$bfcode9 = "$bin$bcode1$bcode2$bcode3$bcode4$bcode5$bcode6$bcode7$bcode8$bcode9$bcode10|$montheTOKYO|$yearTOKYO|$TOKYO";
bot ('EditMessageText',[
    'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=>"`$bfcode\n$bfcode1\n$bfcode2\n$bfcode3\n$bfcode4\n$bfcode5\n$bfcode6\n$bfcode7\n$bfcode8\n$bfcode9`\n- - - - -\n- BY => @iiiiBii .", 
